...
/** Ако има PGPASSWORD во .env, користиме објект-параметри (понадежно од URL на Windows). */
const PGPASSWORD =
...
export async function initDb() {
  ...
  try {
    ...
    /** Стари Node билдери имаа password_hash; Spring/JPA има password */
    await client.query(`
      DO $$
      BEGIN
        IF EXISTS (
